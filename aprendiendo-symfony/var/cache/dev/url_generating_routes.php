...
return [
    ...
    'animales' => [['nombre', 'apellidos'], ['nombre' => 'Davidweb', 'apellidos' => 'avalos', '_controller' => 'App\\Controller\\HomeController::animales'], ['nombre' => '[a-zA-Z ]+', 'apellidos' => '[a-zA-Z ]+'], [['variable', '/', '[a-zA-Z ]+', 'apellidos', true], ['variable', '/', '[a-zA-Z ]+', 'nombre', true], ['text', '/animales']], [], [], []],
    ...
    'validar_email' => [[], ['_controller' => 'App\\Controller\\AnimalController::validarEmail'], [], [['text', '/validar-email']], [], [], []],
];
