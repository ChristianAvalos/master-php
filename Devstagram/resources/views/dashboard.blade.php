...
<div class="flex justify-center">
    <div class="w-full md:w-8/12 lg:w-6/12 flex items-center md:flex-row">
        ...
        <div class="md:w-8/12 lg:w-6/12 px-5 felx flex-col items-center md:justify-center md:items-start py-10 md:py-10">
            ...
            @auth
            @if ($user->id !== auth()->user()->id && !$user->siguiendo(auth()->user()))
