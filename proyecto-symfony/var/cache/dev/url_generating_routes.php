...
return [
    ...
    'task_detail' => [['id'], ['_controller' => 'App\\Controller\\TaskController::detail'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/tarea']], [], [], []],
    ...
    'task_edit' => [['id'], ['_controller' => 'App\\Controller\\TaskController::edit'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/editar-tarea']], [], [], []],
    'task_delete' => [['id'], ['_controller' => 'App\\Controller\\TaskController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/borrar-tarea']], [], [], []],
